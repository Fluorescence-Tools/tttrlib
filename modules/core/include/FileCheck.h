...
// The portable file-open and 64-bit seek helpers moved to the io layer, where
// the format modules can reach them without depending on core. Included here so
// every existing consumer -- and the SWIG interface -- is unaffected.
#include "FileIO.h"
