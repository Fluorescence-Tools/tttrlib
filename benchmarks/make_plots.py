...
TITLES = {
    ...
    "max_tree": "1-D max-tree (component tree)  (2M samples, 1024 levels)",
...
XLABEL = {
    ...
    "hmm_lattice": "steps / second", "hmm_vb": "ticks / second", "max_tree": "samples / second", "phasor": "decays / second",
...
SUMMARY = [
    ...
    ("1-D max-tree", "max_tree", "tttrlib", "scikit-image max_tree"),
