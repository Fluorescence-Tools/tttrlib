...
if __name__ == '__main__':
    ...
    #     number=n_test_runs
    # )
    # print("test_get_decay_image_time: %s" % test_get_decay_image_time)
    #
    ...
    #     number=n_test_runs
    # )
    # print("test_fill_pixels_time: %s" % test_fill_pixels_time)
    #
    ...
    #     number=n_test_runs
    # )
    # print("test_get_decays_time: %s" % test_get_decays_time)
    #
