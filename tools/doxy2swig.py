...
class Doxy2SWIG:
    ...
    def __init__(self, src,
        ...
        glossary.rst from doxygen then set
        ...
        self.ignores = ['inheritancegraph', 'param', 'listofallmembers',
                        ...
                        'references.rst', 'referencedby', 'location',
...
def main():
    ...
    parser.add_option("-f", '--function-signature',
                      ...
                      default=False,
                      dest='f',
                      help='include function signature in the documentation. This is handy when not using swig auto-generated function glossary.rst %feature("autodoc", [0,1])')
