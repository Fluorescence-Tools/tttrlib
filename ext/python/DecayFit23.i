...
// Release the Python GIL around the pure-C++ fitters. R and Java have no
// Python GIL and call the same native implementations without this wrapper.
#ifdef SWIGPYTHON
...
%ignore DecayFit23::fit_tau_only_unpolarized_row;
