...
The same decoders are compared photon for photon with `phconvert
<https://github.com/Photon-HDF5/phconvert>`_ and `ptufile
<https://github.com/cgohlke/ptufile>`_ in the test suite and the benchmark
