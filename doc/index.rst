...
core algorithms are written in C++ and exposed to **Python, R, Java and
JavaScript** from a single shared interface — plus an **ImageJ/Fiji plugin** for
point-and-click FLIM reconstruction. The Python binding integrates with NumPy, SciPy, Matplotlib, and
...
.. list-table::
   ...
   * - Run small examples
     - :doc:`quickstart`
   * - Use Python, R, Java or JavaScript
     - :doc:`languages`
   * - Reconstruct FLIM in ImageJ/Fiji
     - :doc:`imagej-plugin`
   * - Read TTTR files from Node.js
